...
import ScrollReveal, { StaggerContainer, StaggerItems } from "./ui/ScrollReveal";
import Badge from "./ui/Badge";
import Button from "./ui/Button";
import Separator from "./ui/Separator";

import imgEthiopianHarrar from "../assets/Ethiopian-Harrar-Bag.png";
import imgColobainSupremo from "../assets/Colombian-Supremo-Bag.png";
...
const products = [
    ...
    {
        name: "Colobain Supremo",
        origin: "Colombia",
        price: "16.99",
        roast: "Medium-Dark",
        notes: "Caramel, nutty, smooth finish",
        image: imgColobainSupremo,
        badge: null
    },
    {
        name: "Kenya AA",
    ...
    },
    {
        ...
        price: "29.99",
        roast: "Medium",
        notes: "Brown surgar, macadamia, mild acidity",
        image: imgKona,
        badge: null
    },
    {
    ...
    return (
        <div className="product-showcase">
            ...
            <ScrollReveal animation="fadeUp" delay={0.1}>
                <h2 className="produt-showcase-title">
                    Shop Our
                    <br />
            ...
            <ScrollReveal animation="fadeUp" delay={0.15}>
                <p className="produt-showcase-subtitle">
                    Hand-selected single-origin coffees, roasted to order. Each bag vships within 48
                    hours of roasting for maximun freshness.
                </p>
            </ScrollReveal>
            ...
            <StaggerContainer staggerDelay={0.1} className="product-grid">
                {products.map((product) => (
                    <StaggerItem key={product.name} animation="fadeUp">
                        ...
                        {product.badge && (
                            <span className="product-price">{product.badge}</span>
                        )}
                        </div>
